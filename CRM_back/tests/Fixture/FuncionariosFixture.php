...
class FuncionariosFixture extends TestFixture
{
    ...
    // phpcs:disable
    public $fields = [
        'id_funcionario' => ['type' => 'integer', 'length' => 10, 'autoIncrement' => true, 'default' => null, 'null' => false, 'comment' => null, 'precision' => null, 'unsigned' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id_funcionario'], 'length' => []],
        ],
    ];
    // phpcs:enable
    /**
